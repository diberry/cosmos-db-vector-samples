...
const config = {
    ...
    containerName: "hotels_quantized_flat",
...
async function main() {
    ...
    try {
        ...
        // Create container with vector policy (quantized flat index)
        const containerDefinition = {
            ...
            indexingPolicy: {
                vectorIndexes: [
                    {
                        path: `/${config.embeddedField}`,
                        type: VectorIndexType.QuantizedFlat,  // Quantized flat index for better efficiency
